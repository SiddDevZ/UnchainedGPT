...
const BackgroundBeams = dynamic(() => import('../../components/ui/background-beams').then((mod) => mod.BackgroundBeams), {
    ssr: false,
    loading: () => <div></div>
});
    ...
    <div className="dark flex w-full h-screen flex-col items-center justify-center overflow-hidden bg-black">
      <div className="w-full xss:max-w-full sm:max-w-[29rem] sm:h-max xss:h-screen z-10 flex flex-col items-center justify-center sm:px-10 xss:px-5 py-10 rounded-xl border backdrop-filter backdrop-blur-sm bg-white bg-opacity-[0.02]">
        ...
        <div className="flex flex-col gap-4 justify-center w-full">
          <button onClick={() => googleLogin()}  className="border border-[#acacac] hover:border-white hover:scale-[1.02] transition-all ease-in-out gap-2 flex items-center justify-center text-white font-inter w-full font-medium py-2.5 px-4 rounded-full duration-300">
            <img src="google.svg" className="w-[1.7rem]" alt="" />
            Sign up with Google
          </button>
          <button onClick={() => handleDiscordLogin()} className="border border-[#acacac] hover:border-white hover:scale-[1.02] ease-in-out gap-2 flex items-center justify-center text-white font-inter w-full font-medium py-2.5 px-4 rounded-full transition duration-300">
        ...
        <div className="w-full relative">
          <input
            ...
            className="w-full bg-[#1f1f1f] text-white font-inter text-base py-3 px-7 rounded-full focus:outline-none focus:ring-2 focus:ring-[#cccccc] hover:ring-2 hover:ring-[#a2a2a2] focus:border-transparent transition duration-300"
          />
        </div>
        ...
        <button className="mt-6 hover:scale-[1.02] bg-[#f2f2f2] text-black font-inter w-full font-medium py-3 px-4 rounded-full hover:bg-[#e1e1e1] transition duration-300">
          Register with Email
        </button>
